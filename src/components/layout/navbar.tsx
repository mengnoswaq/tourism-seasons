      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-[#2791F5] flex items-center justify-center text-white font-black text-xl shadow-lg shadow-[#2791F5]/25 group-hover:scale-105 transition-transform">
              TS
            </div>
            <div className="flex flex-col">
              <span className="font-black text-xl tracking-tight text-slate-900 leading-none">
                TOURISM<span className="text-[#2791F5]">SEASONS</span>
              </span>
              <span className="text-[10px] tracking-widest text-slate-400 font-semibold uppercase mt-0.5">
                Travel & Seasonal Guides
              </span>
            </div>
          </Link>
